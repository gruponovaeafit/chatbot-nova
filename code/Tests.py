...
class Test_Contexts(unittest.TestCase):
    ...
    def test_question9(self):
        self.assertEqual(NB.get_index("cuales son los macroeventos de nova?"),5)
    ...
    def test_question13(self):
        self.assertEqual(NB.get_index("cual es el objetivo de communities?"),4)
