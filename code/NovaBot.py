...
def generate_response(question):
    ...
    response = client.chat.completions.create(model="gpt-3.5-turbo",messages=[{"role": "system", "content": "Eres un miembro del grupo estudiantil NOVA."},{"role": "user", "content": f"usando el contexto {contextos['Contexto'][cos_distances.index(max(cos_distances))]}, responde:{question}"}])
